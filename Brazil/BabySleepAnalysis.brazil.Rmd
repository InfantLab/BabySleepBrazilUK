...
These are the libraries we use. We use `checkpoint` to fix all their versions to the MRAN snapshot for 1st Feb 2019.
y
...
#exlcude very long or short sleep - probably data errors
